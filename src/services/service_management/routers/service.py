...
@service_router.post(path="", tags=["Services"], status_code=status.HTTP_200_OK)
async def add_service(service: Service, service_handler: ServiceHandler =
...
@service_router.post(path="/upload", tags=["Services"], status_code=status.HTTP_200_OK)
