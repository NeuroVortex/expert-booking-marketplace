...
class AppSetting:
    ...
    def __init__(self):
        ...
        self.__algo_type = os.getenv('APP_TYPE', 'RelationManagement')
    ...
    def __load_credentials(self):
        ...
        directory = os.path.join(self.__directory, self.__credential + ".json")
        file = open(directory, encoding="utf8")
    ...
    def __load_test_credentials(self):
        directory = os.path.join(self.__directory, self.__test_credentials + ".json")
        file = open(directory, encoding="utf8")
    ...
    def __read_credentials(self):
        ...
        lp_db = os.getenv('MARKET_MAKING_DATABASE', db_conf["marketMaking"]["URL"])

        self._credentials["DatabaseConfig"]["marketMaking"]["URL"] = lp_db
        ...
        self._credentials.update({"algorithmType": self.__algo_type})